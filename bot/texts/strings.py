...
POST_CONNECTION_TG_CONNECTED_TOPIC = "Телеграм-форум {channel} подключён! Тема: {topic}"
...
ADMIN_PORTALS_TITLE = "ПОРТАЛЫ И СЕРВИСЫ"
...
CONTENT_SETTINGS_DESC = "Выберите площадку для настройки:"
CONTENT_SETTINGS_NO_PLATFORMS = "Сначала подключите площадку в разделе проекта."
CONTENT_SETTINGS_HINT = "Настройки влияют на генерацию текста и изображений"
CONTENT_PLATFORM_HINT = "Настройки контента для этой площадки"
...
CONTENT_IMAGE_MENU_HINT = "Настройки влияют на AI-генерацию изображений"
CONTENT_HTML_HINT = "Определяет вёрстку статьи на сайте"
CONTENT_PREVIEW_HINT = "Соотношение сторон главного изображения"
CONTENT_ARTICLE_FMT_HINT = "Можно выбрать несколько форматов"
CONTENT_IMAGE_STYLE_HINT = "Можно выбрать несколько стилей"
CONTENT_TEXT_ON_IMAGE_HINT = "0% = без текста, 100% = максимум текста"
CONTENT_CAMERA_HINT = "Имитация стиля конкретной камеры"
CONTENT_ANGLE_HINT = "Можно выбрать несколько ракурсов"
CONTENT_QUALITY_HINT = "Влияет на детализацию изображений"
CONTENT_TONE_HINT = "Цветовая гамма всех изображений"
CONTENT_RESET_DONE = "Настройки сброшены"
CONTENT_BRAND_STYLE_TITLE = "ШАБЛОН СТИЛЯ"
CONTENT_BRAND_STYLE_DESC = (
    "Загрузите файл <b>.md</b> или напишите текст \u2014 образец стиля вашего контента.\n"
    "\n"
    "AI будет адаптировать структуру, подачу и оформление под ваш шаблон."
)
CONTENT_BRAND_STYLE_HINT = "Максимум 2000 символов"
CONTENT_BRAND_STYLE_CURRENT = "Текущий шаблон"
CONTENT_BRAND_STYLE_SAVED = "Шаблон стиля сохранён"
CONTENT_BRAND_STYLE_CLEARED = "Шаблон стиля удалён"
CONTENT_BRAND_STYLE_TOO_LONG = "Слишком длинный текст. Максимум 2000 символов."
CONTENT_BRAND_STYLE_FILE_ERROR = "Не удалось прочитать файл. Отправьте .md или .txt файл."
