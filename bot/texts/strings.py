...
PROJECT_CARD_HINT = "Управляйте проектом и контентом"
...
PROJECT_CREATE_INTERNAL = "Это внутреннее имя для вашего удобства."
...
# Keywords
# -----------------------------------------------
KEYWORDS_EMPTY = "Фразы не добавлены."
KEYWORDS_HINT = "Ключевики \u2014 основа для качественных статей"
KEYWORDS_DELETED_ALL = "Все фразы удалены."
KEYWORDS_CLUSTER_DELETED = "Кластер \u00ab{name}\u00bb удалён."
KEYWORDS_CLUSTER_DELETED_EMPTY = "Кластер \u00ab{name}\u00bb удалён. Фразы закончились."
KEYWORDS_DELETE_ALL_TITLE = "УДАЛЕНИЕ КЛЮЧЕВЫХ ФРАЗ"
KEYWORDS_DELETE_ALL_QUESTION = "Удалить все фразы ({total} фраз, {clusters} кластеров)?"
KEYWORDS_DELETE_ALL_WARNING = "Это действие необратимо."
KEYWORDS_SELECT_DELETE = "Выберите кластер для удаления:"
...
DESCRIPTION_GENERATION_ERROR = "Ошибка генерации. Попробуйте ещё раз."

# -----------------------------------------------
# Prices
# -----------------------------------------------
PRICES_HINT = "В статьях будут реальные цены ваших товаров"
PRICES_EMPTY = "Прайс не загружен."
...
CONNECTIONS_MANAGE_HINT = "Управляйте подключением"
...
PROFILE_HINT = "Управляйте подписками и уведомлениями"

NOTIFICATIONS_TITLE = "УВЕДОМЛЕНИЯ"
NOTIFICATIONS_PROMPT = "Выберите типы уведомлений:"
NOTIFICATIONS_PUBLICATIONS = "Публикации \u2014 статус автопубликаций"
NOTIFICATIONS_BALANCE = "Баланс \u2014 пополнения и низкий баланс"
NOTIFICATIONS_NEWS = "Новости \u2014 обновления бота"
...
REFERRAL_DESC = "Приглашайте друзей и получайте <b>10%</b> от каждой их покупки!"
...
ARTICLE_ERROR_TITLE = "ОШИБКА ГЕНЕРАЦИИ"
ARTICLE_ERROR_REFUND = "Токены возвращены на баланс."
ARTICLE_ERROR_HINT = "Попробуйте ещё раз или выберите другую тему"
...
SCHEDULE_HINT = "Настройте частоту автопубликации"
SCHEDULE_SOCIAL_HINT = "Настройте частоту автопостинга"
...
VALIDATION_NAME_LENGTH = "Название должно быть от 2 до 100 символов. Попробуйте ещё раз."
VALIDATION_URL_INVALID = "Некорректный URL. Попробуйте ещё раз."
...
VALIDATION_TOKEN_INVALID = "Некорректный формат токена. Попробуйте ещё раз."
VALIDATION_CHANNEL_INVALID = "Некорректный формат. Введите @channel или t.me/channel."
VALIDATION_PASSWORD_SHORT = "Application Password слишком короткий. Попробуйте ещё раз."
