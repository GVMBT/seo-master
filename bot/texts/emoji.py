...
class _EmojiTags:
    ...
    TRANSFER = _tag("5305514796567795035", "\U0001f500")
    ...
    # Communication
    CROWN = _tag("5305266994134685124", "\U0001f451")
    MEGAPHONE = _tag("5305703826668428473", "\U0001f4e2")
    EDIT_DOC = _tag("5305634269673066495", "\U0001f4dd")
    AI_BRAIN = _tag("5305729815515533141", "\U0001f9e0")
    DATABASE = _tag("5305514796567795035", "\U0001f4be")
    PULSE = _tag("5305462853233318552", "\U0001f4a1")
    SUPPORT = _tag("5305509505168086814", "\U0001f6e0")

    # Extra platforms
    INSTAGRAM = _tag("5305654597753279465", "\U0001f4f7")
    YOUTUBE = _tag("5305643301989290953", "\U0001f3ac")
    TIKTOK = _tag("5305396259765394964", "\U0001f3b5")
    FACEBOOK = _tag("5305702774401439462", "\U0001f30d")
    TWITTER = _tag("5305643301989290953", "\U0001f426")
    TELEGRAPH = _tag("5305560855797077870", "\U0001f4e8")
