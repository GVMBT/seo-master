...
TG_STEP3_TOPIC = (
    f"{E.TELEGRAM} <b>ПОДКЛЮЧЕНИЕ TELEGRAM</b>\n\n"
    "Ваш канал — форум с темами.\n"
    "Куда публиковать?\n\n"
    f"{E.N1} <b>Основная тема</b> \u2014 General, без указания темы\n"
    f"{E.N2} <b>Создать тему</b> \u2014 бот создаст отдельную тему для постов\n\n"
    f"{_SEP}\n"
    f"{E.LIGHTBULB} <i>Позже можно пересоздать подключение для другой темы</i>"
)

TG_TOPIC_NAME_PROMPT = (
    f"{E.TELEGRAM} <b>ПОДКЛЮЧЕНИЕ TELEGRAM</b>\n\n"
    "Введите название темы для публикаций\n\n"
    "<i>Пример: SEO-контент</i>"
)
