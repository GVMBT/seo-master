...
_STYLE_BY_MATERIAL: dict[str, str] = {
    "wpc": (
        ...
        "ALLOWED USE-CASES (5V): full wall coverage, accent wall (e.g. behind "
        "TV / behind bed headboard / behind sofa), media zone fragment, "
        "window or door reveal trim, ceiling cover or ceiling fragment, "
        "smooth radius transition between wall and ceiling, curved/radius "
        "walls, columns, archways, barfront — WPC bends to gentle radii "
        "for these dimensional effects. DO NOT show the panel as flooring "
        "or as exterior facade. "
