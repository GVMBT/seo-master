...
_SEEDS_BY_MATERIAL: dict[str, list[str]] = {
    "wpc": [
        # 5P (2026-04-28): WPC у Bamboodom = ТОЛЬКО стеновые панели для
        # ИНТЕРЬЕРА. Не фасады, не пол, не уличная отделка, не терраса,
        # не бассейн (как материал у бортика снаружи). Все seeds должны
        # явно указывать на интерьер/комнату.
        # core
        "wpc стеновые панели",
