...
_SEEDS_BY_MATERIAL: dict[str, list[str]] = {
    "wpc": [
        ...
        # ── зоны применения / типы декорирования (5V) ──
        "стеновые панели на откосы окон",
        "стеновые панели на оконные откосы",
        "стеновые панели на дверные откосы",
        "тв зона стеновые панели",
        "панели за телевизором",
        "акцентная стена wpc",
        "акцентная стена в гостиной",
        "акцентная стена за диваном",
        "акцентная стена в спальне за изголовьем",
        "wpc панели на потолок",
        "wpc панели переход стена потолок",
        "wpc панели радиусная стена",
        "wpc панели изогнутая стена",
        "wpc панели криволинейная поверхность",
        "wpc панели на колонну",
        "панели на изогнутый потолок",
        "панели обшить всю комнату",
        "wpc панели в нишу",
    ],
    "flex": [
        "гибкая керамика",
