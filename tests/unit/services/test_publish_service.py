...
from db.models import Category, PlatformConnection, User
...
async def test_no_keywords_e17() -> None:
    """E17: No keywords configured returns error."""
    svc = _make_service()
    svc._users.get_by_id = AsyncMock(return_value=_make_user())
...
async def test_insufficient_balance_e01(
    ...
    """E01: Insufficient balance returns error and marks schedule as error."""
    svc = _make_service()
