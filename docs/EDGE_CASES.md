...
| E23 | Пул кластеров: <3 кластеров в категории | При автопубликации: добавить в отчёт "Добавьте ещё ключевых фраз для разнообразия контента. [Подобрать фразы]". Минимальный пул — 3 кластера |
