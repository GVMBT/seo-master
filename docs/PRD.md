...
| F42 | ~~Быстрая публикация в 1 клик~~ | Replaced by Goal-Oriented Pipeline (см. [PIPELINE_UX_PROPOSAL.md](PIPELINE_UX_PROPOSAL.md)). Pipeline: "Написать статью" / "Опубликовать пост" → readiness check → генерация → публикация | P1 |
...
| Валовая маржа | ($3 000 - $1 707) / $3 000 | **~43%** (при 500 MAU; улучшается с ростом за счёт фиксированных расходов) |
